 ...
 */
class UnzerIsAuthorizeSucceededConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->checkIsAuthorizeSucceededOmsCondition($orderItem->getIdSalesOrderItem());
    }
}
