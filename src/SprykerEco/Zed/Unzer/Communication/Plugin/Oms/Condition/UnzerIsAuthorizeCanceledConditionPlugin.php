 ...
 */
class UnzerIsAuthorizeCanceledConditionPlugin extends AbstractPlugin implements ConditionInterface
{
    /**
     * {@inheritDoc}
    ...
    {
        return $this->getFacade()->checkIsAuthorizeCanceledOmsCondition($orderItem->getIdSalesOrderItem());
    }
}
