 ...
 */
class UnzerMerchantPostUpdatePlugin extends AbstractPlugin implements MerchantPostUpdatePluginInterface
{
    /**
     * {@inheritDoc}
     * - Saves merchant unzer id after the merchant is updated.
     *
     * @api
     *
