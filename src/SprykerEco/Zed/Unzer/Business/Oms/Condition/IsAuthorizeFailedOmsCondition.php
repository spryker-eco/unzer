...
class IsAuthorizeFailedOmsCondition implements UnzerConditionInterface
{
    /**
    ...
    public function check(int $idSalesOrderItem): bool
    {
        ...
        return $paymentUnzerOrderItemTransfer->getStatus() === $this->unzerConfig->getOmsStatusAuthorizeFailed();
    }
}
