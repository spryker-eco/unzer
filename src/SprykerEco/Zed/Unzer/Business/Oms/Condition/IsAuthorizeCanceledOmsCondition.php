...
class IsAuthorizeCanceledOmsCondition implements UnzerConditionInterface
{
    /**
    ...
    public function check(int $idSalesOrderItem): bool
    {
        ...
        return $paymentUnzerOrderItemTransfer->getStatus() === $this->unzerConfig->getOmsStatusAuthorizeCanceled();
    }
}
