...
class UnzerMarketplaceSofortSubFormPlugin extends AbstractPlugin implements SubFormPluginInterface
{
    /**
     * {@inheritDoc}
     * - Creates `Marketplace Sofort` subform.
     *
     * @api
     *
    ...
    {
        return $this->getFactory()->createMarketplaceSofortSubForm();
    }

    /**
     * {@inheritDoc}
     * - Creates `Marketplace Sofort` subform data provider.
     *
     * @api
     *
    ...
    {
        return $this->getFactory()->createMarketplaceSofortFormDataProvider();
    }
}
